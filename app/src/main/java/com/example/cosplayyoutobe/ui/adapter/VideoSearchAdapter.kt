...
import com.example.cosplayyoutobe.ui.viewholder.VideoSearchViewHolder
...
class VideoSearchAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        return VideoSearchViewHolder(binding, onClickItemVideoListener)
    }

    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        (holder as VideoSearchViewHolder).bind(listAdapter[position], position, context)
    }
